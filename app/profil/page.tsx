...
export default function ProfilPage() {
  ...
  useEffect(() => {
    ...
    trackProfileInteraction({
      ...
      scroll_depth: null,
      came_from: `profil:view:${mode}`,
      device_type: 'web',
      user_agent: typeof navigator !== 'undefined' ? navigator.userAgent : null,
    })
  }, [currentUserId, sessionId, mode])
            ...
            <section className="bg-gradient-to-r from-[#D4AF37]/10 to-transparent rounded-xl p-4 border-l-2 border-[#D4AF37]">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-serif text-white">{MOCK_CLIENT_PROFILE.outfitCount} tenuses enregistrées</p>
                </div>
